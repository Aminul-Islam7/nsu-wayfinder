...
- **Current UI focus**: Search card overlay is highly simplified and concise. The two most recent origin/destination selections are persisted in a cookie and shown first in both dropdown search lists. Floating route controls are polished with clear recenter and route-restore affordances. Mobile level selector is concise and horizontal at the bottom of the screen.
- **Key Concepts**:
